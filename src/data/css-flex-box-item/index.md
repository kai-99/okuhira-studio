...
これから詳しく解説していきますが、`flex-grow` は <mark>**余ったスペース**を各アイテム要素で分け合う</mark> 際に使うプロパティです。
...
この余ったスペース <mark>600px</mark> を <mark>1:2:3</mark> で再分配したということになります。
...
これから詳しく解説していきますが、`flex-shrink` は <mark>アイテム要素がコンテナ要素の幅より大きかった</mark> 際に使うプロパティです。
...
この飛び出している幅 <mark>600px</mark> を <mark>1:2:3</mark> で再分配したということになります。
